...
NORRN_player_units = [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,s15,s16];
...
_revive_damage 					= 0.1;				//array no.37 - Unit's level of damage following revive
_unconscious_markers 			= 1;				//array no. 4 - Whether a marker appears on the game map at the location of the unconscious unit
_caseVAC						= [1, ["I44_tent_a_small","I44_tent_a_large"]];	//array no.64 - Allows units to be taken to a hospital etc to be revived
...
_medic_bandages 				= 30;				//array no.85 - Bandages stop bleeding		
