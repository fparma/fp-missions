...
NORRN_player_units = [unit,unit_1,unit_2,unit_3,unit_4,unit_5,unit_6,unit_7,unit_8,unit_9,unit_10,unit_11,unit_12,unit_13,unit_14,unit_15,unit_16,unit_17,unit_18,unit_19];
// ==================================================================
// WELCOME SCREEN
...
// ==================================================================
// REVIVE OPTIONS
_max_respawns 					= (paramsArray select 0);			//array no.38 - Number of lives per unit
...
_lower_bound_heal 				= 0.5;				//array no.30 - The damage level range between which the heal action becomes available 
