...
//_units = {if (side _x == EAST) then {_units = _units + [_x]};}forEach playableUnits;
//NORRN_player_units = _units;
NORRN_player_units = ["b1","b2","b3","b4","b5","b6","b7","b8","b9","b10","b11","b12","b13","b14","b15","b16","b17","b18","b19","b20","b21","b22","b23","b24","b25","b26","b27"];
// ==================================================================
// WELCOME SCREEN
...
// ==================================================================
// REVIVE OPTIONS
_max_respawns 					= (paramsArray select 2);			//array no.38 - Number of lives per unit
...
_allied_side_1 					= "CIVILIAN";			//array no.42 - Friendly sides can be "EAST", "WEST","RESISTANCE" etc.  
