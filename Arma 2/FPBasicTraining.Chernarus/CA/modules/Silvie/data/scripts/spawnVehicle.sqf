...
if (count(_cuelspawnpos) == 0) exitWith {diag_log text "SILVIE: Did not find spawn pos!";};
_cuelspawnpos = _pos findEmptyPosition[ 1 ,50 , _class];
_car = createvehicle [_class, _cuelspawnpos, [], _radius, "none"];
sleep 0.02;
