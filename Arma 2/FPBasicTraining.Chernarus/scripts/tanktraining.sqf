...
_ui addAction ["-----------------------", ""];
_ui addAction [">> Spawn static fake tank", "scripts\tankspawn.sqf",(0)];
_ui addAction [">> Spawn moving technical", "scripts\tankspawn.sqf",(1)];
_ui addAction [">> Spawn moving APC", "scripts\tankspawn.sqf",(2)];
_ui addAction [">> Spawn moving tank", "scripts\tankspawn.sqf",(3)];
_ui addAction ["-----------------------", ""];