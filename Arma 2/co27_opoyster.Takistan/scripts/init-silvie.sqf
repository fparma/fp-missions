...
BIS_silvie_mainscope setVariable ["blackList", ["Land_HBarrier5","Land_fort_bagfence_long","Land_HBarrier1","Land_fort_rampart_EP1","Land_Fort_Watchtower_EP1","Land_fortified_nest_small_EP1","Fort_RazorWire"]]; 
