	...
	switch (_chance) do
	{
		case 0: {
			_box addWeaponCargoGlobal ["M60A4_EP1", 1];
 			_box addMagazineCargoGlobal ["100Rnd_762x51_M240", _amountAmmo];
		};
		case 1: {
			_box addWeaponCargoGlobal ["RPK_74", 1];
 			_box addMagazineCargoGlobal ["75Rnd_545x39_RPK", _amountAmmo];
		};
		case 2: {
			_box addWeaponCargoGlobal ["M249", 1];
 			_box addMagazineCargoGlobal ["100Rnd_556x45_BetaCMag", _amountAmmo];
		};
	};
    };
