...
_this addWeaponCargoGlobal ["AK_74_GL", _amountWeapon+5]; _this addMagazineCargoGlobal ["1Rnd_HE_GP25", _amountAmmo+20];
...
_this addWeaponCargoGlobal ["SVD", _amountWeapon]; _this addMagazineCargoGlobal ["10Rnd_762x54_SVD", _amountAmmo];
