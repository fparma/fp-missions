...
[nil,nil,"per",rTitleCut,"All VIP objectives completed!", "BLACK IN", 6] call RE;sleep 5; [nil,nil,"per",rENDMISSION,"END1"] call RE; 
};

[]spawn {
while {!vipDead} do {sleep 2};
["killviptask", "succeeded"] call SHK_Taskmaster_upd;
[nil,nil,"per",rTitleCut,"The VIP has been assassinated.", "BLACK IN", 6] call RE;
sleep 5;
