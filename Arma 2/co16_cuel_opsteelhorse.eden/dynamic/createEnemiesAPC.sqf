...
_unitTank1 = _groupTank createUnit ["cwr2_SoldierE_Crew", [(getMarkerPos _spawnPos) select 0,(getMarkerPos _spawnPos) select 1,1], [], 1, "NONE"];
_unitTank2 = _groupTank createUnit ["cwr2_SoldierE_Crew", [(getMarkerPos _spawnPos) select 0,(getMarkerPos _spawnPos) select 1,1], [], 1, "NONE"];
_unitTank3 = _groupTank createUnit ["cwr2_SoldierE_Crew", [(getMarkerPos _spawnPos) select 0,(getMarkerPos _spawnPos) select 1,1], [], 1, "NONE"];
