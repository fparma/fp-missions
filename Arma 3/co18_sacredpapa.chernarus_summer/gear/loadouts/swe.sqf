...
_COMMON_VESTS = ["LOP_V_CarrierRig_OLV", "LOP_V_CarrierLite_OLV"];
_COMMON_HEADGEARS = ["FP_Helmet_M90"];
_COMMON_BP = "CUP_B_ACRPara_m95";
...
_SQL_VEST = "LOP_V_CarrierRig_OLV";
...
switch _kit do {
    ...
    case "SQL":
    {
        ...
        else {_h = _SQL_HEADGEAR};

        [_unit, [_SQL_UNIFORM, _SQL_VEST, _h, "CUP_B_ACRScout_m95"]] call FP_fnc_addContainers;
