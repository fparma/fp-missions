...
["Diary",["Intel","
UKR Rebels. Mostly infantry, light vehicles.
"]];

player createDiaryRecord
["Diary",["Execution","
1)<br /> Locate the two (2) weapons caches and destroy them
"]];

player createDiaryRecord
["Diary",["Briefing","
<br />We have solid intel that UKR Rebels are hiding two weapons caches
with heavy AT and/or explosives somewhere on the positions marked on the map<br />
It is vital that you find these and destroy them.<br /><br />
Search suspicous buildings, find the caches and blow them up.
"]];
