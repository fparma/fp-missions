...
switch (toUpper _type) do {
	...
	case "NATO":{
		_units = ["FP_Faction_USAREUR60_TL","FP_Faction_USAREUR60_SL","FP_Faction_USAREUR60_DM","FP_Faction_USAREUR60_AR","FP_Faction_USAREUR60_medic","FP_Faction_USAREUR60_RAT","FP_Faction_USAREUR60_Rifleman","FP_Faction_USAREUR60_Rifleman"];
		_specialUnits = ["B_soldier_LAT_F"];
		_airdropUnit = "RHS_C130J";
	};
	case "FIA":{
