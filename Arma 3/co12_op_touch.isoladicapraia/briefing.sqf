...
This is the only available photo of the HVT.
<br />
<br />
<img image='guy2.jpg' width='400' height='400'/>
"]];

player createDiaryRecord
["Diary",["Intel","
Intel shows mostly infantry patrols, possibly technicals armed with .50cal
"]];

player createDiaryRecord
["Diary",["Execution","
<br />
1) Maintain stealth to not attract reinforcements from the nearby army base<br />
1) Take out the two BTRs and the speedboat in the port<br />
2) Eliminate the HVT, who is spending the night in the Villa. See attached photo for conformation<br />
3) Once all objectives are completed, head back to the drop point for extraction.
<br />
<br />
You may choose to complete the objectives in any order you want.
<br />
NOTE: If you are discovered the HVT might try to escape.<br />
NOTE: The enemy might utilize the BTRs if you do not maintain stealth.<br />
"]];

player createDiaryRecord
["Diary",["NOTE","
Use the action menu to put on your uniform. It cannot be taken on again unless it's in your backpack
"]];
...
player createDiaryRecord ["fp_radios", ["Channels", "
	[ Alpha ] : 1 <br />
	[ Bravo ] : 2 <br />
	[ Alt channel (SQLs) ] : 3 <br />
"]];
