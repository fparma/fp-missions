/*
	Function: FP_fnc_getPlayerFromName
	...
	Description:
		...
		Can be used partially, to find "cuel" you can pass ["cu"] call FP_fnc_getPlayerFromName
	...
	Examples:
	(begin example)
		_cuel = ["Cuel"] call FP_fnc_getPlayerFromName;
	(end)
