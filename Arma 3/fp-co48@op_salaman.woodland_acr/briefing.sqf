...
["Diary",["Logistics","
<br />
Respawns mounts up in the truck to be transported back to the field.
<br />
Trucks might wait for more respawns before leaving.
<br /><br />
If both trucks are missing, wait for them to come back.
"]];

player createDiaryRecord
["Diary",["Intel","
<br />
Last nights recon mission gave the following intel:
<br /><br />
'Novy Sobor has a static tower on the west side with a heavy machine gun and several patrols and sandbag fortifications.
<br />
The east side have a vehicle barricade and more patrols. Mostly infantry seen'
<br /><br />
'Stary Sobor is heavily defended and has several fortification and a few heavy machine guns
<br />
On the west and east side hidden in camonets are two D30 heavy AT
<br />
Two helipads. Patrols, suspected MBTs and APCs
<br />
Behind the helipad is a static radar and ZSU hidden in a camonet'
"]];
...
player createDiaryRecord
["Diary",["Briefing","
The Russian HQ is located in Stary Sobor, it is well defended and will be hard to take.
<br />
Novy Sobor is also a strongpoint and must be taken control of.
"]];
...
player createDiaryRecord ["fp_radios", ["Group channels", "
	...
	[ Actual ] : 5 <br />
	[ Engineer ] : 6 <br />
	Battle busses and Falcon will use the attached squads radio channel.
"]];
