...
switch (toUpper _type) do {
	case "AFM": {
		_units = ["LOP_AM_Soldier_TL","LOP_AM_Soldier","LOP_AM_Soldier_SL","LOP_AM_Soldier","LOP_AM_Soldier_GL","LOP_AM_Soldier","LOP_AM_Soldier","LOP_AM_Soldier_AR""LOP_AM_Soldier"];
		_specialUnits = ["LOP_AM_Soldier_AT"];
		_airdropUnit = "";
	};
	case "CSAT": {
