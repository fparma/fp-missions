...
["Diary",["Intel","
We have barely any intel but suspect Militia forces.
"]];

player createDiaryRecord
["Diary",["Execution","
1) Locate the two patrol vehicles<br /><br />
2) Account for all personnel. (total of 8)<br /><br />
"]];

player createDiaryRecord
["Diary",["Briefing","
Two patrol cars left the base 2 hours ago and reported that they were under attack just before we lost radio contact<br /><br />

Your mission is to find out what happened to them.<br />
"]];
