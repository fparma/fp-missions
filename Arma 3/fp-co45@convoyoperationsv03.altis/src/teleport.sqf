...
///////////////////////////
	...
	Takes an array format: [TELEPORT_OBJECT,["DISPLAY_NAME","unitName"],["DISPLAY_NAME2","unitName2"]]
	Note the string format for units.
	Version: 0.1
	example init.sqf: [flag_obj,["Alpha 1", "a1"]] execVM "src\teleport.sqf";
///////////////////////////
*/
...
FP_query_TP = {
	...
	if (time < FP_timeout) exitWith {hint 'You have recently died and cannot use this flag. It is for JiPs'};
