...
["Diary",["Intel","
	FIA forces are much more numerous and well funded than they were previously. Expect heavy resistance, antitank equipment, armored vehicles, and possibly air contacts.
"]];

player createDiaryRecord 
["Diary",["Execution","
	Assemble your troops and vehicles, and move out in a convoy. Our only objective is to reach Castle Thronos, which is our only hope of making it off Altis alive. Recon has plotted a safe route to Thronos. DO NOT DEVIATE FROM THIS ROUTE, as other routes have not been checked for IED's. In addition, there are two bases we have made contact with, who are currently holding out against the FIA. Conveniently, they lie right along our planned route. Should you lose any men, you will find replacements there.
"]];

player createDiaryRecord 
["Diary",["Briefing","
	The FIA has returned, now backed by NATO. They have recieved massive amounts of funding and their insurgency has begun again. They have overthrown the island of Altis and most of our superiors in the AAF have been destroyed or routed. Our only hope is to reach Castle Thronos, the highest point on Altis, so we can send an emergency communique to our allies in Turkey.
"]];
