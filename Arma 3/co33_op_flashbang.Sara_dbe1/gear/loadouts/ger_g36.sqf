...
// ==================
_COMMON_UNIFORMS = ["FP_Uniform_FlecktarnGreen"];
_COMMON_VESTS = ["FP_Carrier_mcamPatchless"];
_COMMON_HEADGEARS = ["FP_Helmet_Flecktarn"];
...
_COMMON_ITEMS = ["ACRE_PRC343", ["HandGrenade", 2], ["SmokeShellGreen", 2], "ItemMap","ItemCompass","ItemWatch", ["ACE_fieldDressing", 2], "ACE_Morphine", "ACE_Flashlight_MX991"];

_COMMON_RIFLE = "hlc_rifle_G36KE1";
_COMMON_RIFLE_ATTACHMENTS = ["HLC_Optic_G36Dualoptic15x"];
_COMMON_MAG = "hlc_30rnd_556x45_SOST_G36";
_COMMON_MAG_T = "hlc_30rnd_556x45_EPR_G36";

_COMMON_RIFLE_C = "hlc_rifle_G36CTac";
_COMMON_RIFLE_C_ATTACHMENTS = "RH_compm4s";
_COMMON_MAG_C = _COMMON_MAG;
_COMMON_MAG_C_T = _COMMON_MAG_T;

_COMMON_RIFLE_GL = "hlc_rifle_G36E1AG36";
_COMMON_RIFLE_GL_ATTACHMENTS = "HLC_Optic_G36dualoptic35x";
_COMMON_GL_NADES = [["1Rnd_HE_Grenade_shell", 4], ["1Rnd_Smoke_Grenade_shell", 2], ["UGL_FlareRed_F", 2], "1Rnd_SmokeRed_Grenade_shell", "1Rnd_SmokeGreen_Grenade_shell"];
...
_SQL_ITEMS = ["ACRE_PRC148", "ACE_microDAGR", "ACE_MapTools", "Chemlight_green", "Chemlight_green"];
...
switch _kit do {
    ...
    case "SPOTTER";
    case "RIFLEMAN": {
        [_unit, [_COMMON_UNIFORMS, _MED_VEST, _MED_HEADGEAR]] call FP_fnc_addContainers;
        ...
        if (_kit == "SPOTTER") then {
            [_unit, "laser"] call FP_fnc_addOptic;
        };
    };

    case "AR": {
        [_unit, [_COMMON_UNIFORMS, _COMMON_VESTS, _COMMON_HEADGEARS, "usm_pack_762x51_ammobelts"]] call FP_fnc_addContainers;
    ...
    case "ARASS": {
        [_unit, [_COMMON_UNIFORMS, _COMMON_VESTS, _COMMON_HEADGEARS, "usm_pack_762x51_bandoliers"]] call FP_fnc_addContainers;
        [_unit, [[_COMMON_MAG, 6], [_COMMON_MAG_T, 4]]] call FP_fnc_addToContainers;
        [_unit, [_COMMON_RIFLE, _COMMON_RIFLE_ATTACHMENTS]] call FP_fnc_addWeapon;
    ...
    case "GL": {
        [_unit, [_COMMON_UNIFORMS, _COMMON_VESTS, _COMMON_HEADGEARS]] call FP_fnc_addContainers;
        [_unit, [[_COMMON_MAG_GL, 8], [_COMMON_MAG_GL_T, 2], [["1Rnd_HE_Grenade_shell", 6], ["1Rnd_Smoke_Grenade_shell", 2]]]] call FP_fnc_addToContainers;
