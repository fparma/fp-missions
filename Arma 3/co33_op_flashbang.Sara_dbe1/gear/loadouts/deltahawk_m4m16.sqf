...
_COMMON_ITEMS = ["ACE_CableTie", "ACRE_PRC343", ["SmokeShellGreen", 2], ["HandGrenade", 2], "ItemMap","ItemCompass","ItemWatch", ["ACE_fieldDressing", 2], "ACE_Morphine", "ACE_Flashlight_MX991"];
...
switch _kit do {
    ...
    case "SQL": {
        ...
        if (str _unit == "gm") then {_h = "H_Beret_Colonel"};
    ...
    case "REPORTER": {
        [_unit, ["U_C_Journalist", "V_Press_F", "FP_Helmet_Tan"]] call FP_fnc_addContainers;
        [_unit, ["ACRE_PRC343", "ACE_fieldDressing", "ACE_fieldDressing", "ItemMap","ItemCompass","ItemWatch", "ItemGPS"]] call FP_fnc_addToContainers;
    };
