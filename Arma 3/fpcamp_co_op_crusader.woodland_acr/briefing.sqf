...
Date: 1995-07-27<br/>
Time: 10:00<br/>
Few clouds, chance of rain.<br/>
"]];

player createDiaryRecord
["Diary",["Intel","
We have minefields on the northern roads from Elektrozavodsk.
<br/><br/>
The west minefield was successful and took out a reinforcement truck
<br/><br/>
No more intel available.
"]];

player createDiaryRecord
["Diary",["Execution","
<br/>
Push East to Elektrozavodsk and,
<br/><br/>
1) Secure the docks in southern Elektrozavodsk.
<br/><br/>
2) Secure the Russian HQ, assumed to be in NE Elektrozavodsk
<br/><br/>
3) Defend against potential Russian reinforcements or counter attacks.
"]];

player createDiaryRecord
["Diary",["Briefing","
<br/>
Securing Chernogorsk was a great drawback for the Russian forces.
Our next target is Elektrozavodsk, a heavily fortified city to the East.
<br/><br/>
During the previous nights, two special forces missions have been completed.
<br/><br/>
1) SF forces planted minefields to prevent reinforcements and counter attacks heading towards Elektrozavodsk.
<br/>
2) SF forces took out two radar trucks heading north.
<br/><br/>
The special forces have however not gathered any intel regarding how well defended Elektrozavodsk is.
<br/><br/>
We expect minefields, APC's and perhaps even tanks, along with give or take a hundred Russian infantry.
<br/><br/>
Good luck.
"]];
