...
[
  ...
  ["B_support_MG_F", "hmg.sqf"],
  ["B_support_AMG_F", "hmg_asst.sqf"],
  ["B_Soldier_AT_F", "at.sqf"],
  ["B_Soldier_AAT_F", "at_asst.sqf"],

  ["B_recon_TL_F", "recon_sql.sqf"],
  ["B_recon_Medic_F", "recon_medic.sqf"],
  ["B_recon_exp_F", "recon_demo.sqf"],
