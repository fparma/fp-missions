...
switch (side player) do {
    case blufor:  {
        _sideBriefing =
        "One of our helicopters managed to assault a russian vehicle convoy, one of the vehicles was carrying an experimental device. <br />
        It is imperative that this device is secured. The russians can not have it back. Currently your team are the only ones close to it, you will have to defend it until reinforcements arrive. <br /> <br />Best of luck.
        ";
    };
    case opfor:  {
        _sideBriefing =
        "
        A NATO helicopter engaged a vehicle convoy that was carrying the X-593 XP+ experimental device. This device cannot fall into NATO hands and needs to be activated. <br />
        Your team are the only ones close enough to engage the small NATO recon troop that was dispatched until heavy armor arrives. <br /> <br />
        Either wipe them all out so you can drive the vehicle out of there OR activate the device. It should take around 20seconds to fully connect and upload the activation code <br /> <br />Best of luck.
        ";
    };
    case independent:  {
        _sideBriefing =
