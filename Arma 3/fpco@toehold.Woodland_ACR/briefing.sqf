...
["Diary",["Intel","
<br/>
Soviet forces are commited to this push as it is the last remaining US sector in the area.<br/>
We do not have much intel on their forces, but they are strong. Expect anything.<br/>
"]];

player createDiaryRecord 
["Diary",["Execution","
Defend the DFPs while personnel and civilians are being evacuated across the train bridge.<br/><br/>
Last line of defense is FOB Gangplank.<br/><br/>
We are not expecting to hold off the Soviet forces but must buy some time for the evac<br/><br/>
Good luck.
"]];

player createDiaryRecord 
["Diary",["Briefing","
Things are going badly on the Czechoslovakian front.<br/>
After the near-collapse of the USSR, Soviet forces (backed by reactionary elements of the former Warsaw Pact countries) pushed to the West German border and began engaging NATO in heavy fighting. Now, five years on, both sides are stretched thin.<br/>
Strategic reserves are near non-existent on both sides. <br/><br/>
The Soviets have committed their remaining fresh forces to an assault in this sector of Czechoslovakia, and a small US infantry unit must resist their push.<br/>
"]];
