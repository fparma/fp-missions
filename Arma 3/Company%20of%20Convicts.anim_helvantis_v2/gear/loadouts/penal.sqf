...
_UNCOMMON_ITEMS = ["ItemMap","ItemCompass","ItemWatch", "ACE_microDAGR", "ACE_MapTools", "ACRE_PRC148_ID_1", "ACE_fieldDressing","ACE_fieldDressing", "ACE_fieldDressing", "SmokeShell", "ACE_morphine"];
...
switch _kit do {
     ...
     case "MGASS":
    {
		...
		// [_unit, [_MG_RIFLE]] call FP_fnc_addWeapon;
